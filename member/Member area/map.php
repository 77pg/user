...
$locations = [
    ...
    "苗栗縣" => ["苗栗市", "頭份市", "竹南鎮", "後龍鎮", "通霄鎮", "苑裡鎮", "卓蘭鎮", "造橋鄉", "三義鄉", "獅潭鄉", "泰安鄉", "三灣鄉", "南庄鄉", "銅鑼鄉", "頭屋鄉", "公館鄉", "大湖鄉", "鍋燒館", "西湖鄉"],
    ...
    "台南市" => ["中西區", "東區", "南區", "北區", "安平區", "安南區", "永康區", "歸仁區", "新化區", "左鎮區", "玉井區", "楠西區", "南化區", "仁德區", "關廟區", "龍崎區", "官田區", "麻豆區", "佳里區", "西港區", "七股區", "將軍區", "學甲區", "北門區", "新營區", "後壁區", "白河區", "東山區", "六甲區", "下營區", "柳營區", "鹽水區", "善化區", "新市區", "大內區", "山上區", "新興區", "安定區"],
